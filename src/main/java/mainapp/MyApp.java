...
import com.subscription.test.SubscriptionTest;

public class MyApp {

	public static void main(String[] args) throws IOException {

		String sourcePath = "src/main/java/com/subscription/test/SubscriptionTest.java";
		String destPath = "src/test/java/com/subscription/test/SubscriptionTest.java";
		...
		try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
			...
			while ((linen = br.readLine()) != null) {
				...
				// Check if the third column exists and contains "SubscriptionService"
				if (columns.length > 2 && columns[2].contains("SubscriptionService")) {
